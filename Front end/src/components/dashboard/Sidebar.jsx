  ...
  return (
    <button
      ...
      style={{
        ...
        ...(isActive ? { background: 'linear-gradient(135deg, #f97316 0%, #fb923c 100%)', boxShadow: '0 4px 12px rgba(249,115,22,0.3)' } : {}),
      }}
    >
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <img src="/hiremind-logo.jpeg" alt="HireMind" style={{ height: 28, width: 'auto', objectFit: 'contain' }} />
        </div>
